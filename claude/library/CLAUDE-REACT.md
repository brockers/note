...
│   └── [feature]/
│       ├── _tests/     # Co-located tests (MUST be documented)
...
- **MUST co-locate tests** with components in `_tests` folders
 ...
 * @module features/user/_tests/UserProfile.test
 */
...
5. **MUST co-locate related files** - Tests MUST be in `_tests` folders
