# Create a PRODUCT Requirements Prompt (PRP) in claude/PRPs/
...
2. **External Research at scale**
   ...
   - For critical pieces of documentation add a .md file to claude/PRPs/ai_docs and reference it in the PRP with clear reasoning and instructions
...
Using claude/PRPs/templates/prp_base_typescript.md as template:
